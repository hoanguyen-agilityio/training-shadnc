  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen">
        {/* Header */}
        <div className="@container/structure max-w-container mx-auto px-10 w-full">
          <Header />
        </div>

        {/* Main (flex-grow to fill remaining space) */}
        <main className="@container/main flex-grow flex items-center justify-center p-10">
          <section className="max-w-custom-8xl text-center">
            <div className="flex justify-center">
              <NotFound className="w-auto h-auto" />
            </div>
